		...
		<section className='2xl:max-container relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20'>
			<div className='hide-scrollbar flex h-[340px] w-full items-start justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]'>
				<CampSite
					...
					title='Downtown Frederick'
					subtitle='Frederick, Maryland'
			...
			<div className='flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6'>
				<div className='bg-blue-900 p-8 lg:max-w-[500px] xl:max-w-[734px] xl:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl'>
					<h2 className='regular-24 md:regular-32 2xl:regular-64 capitalize text-white'>
						<strong>Need a New</strong> Porch or laying new Roof?
					</h2>
					<p className='regular-14 xl:regular-16 mt-5 text-white'>
						Start by calling Anytime Services LLC to get a quote and find out the best price in your area!
					</p>
